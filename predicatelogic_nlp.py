...
"""
# EXTERNAL IMPORTS - this is the version that drives the boat, apparently.
import nltk
...
globalsentence = [] # ONLY USED FOR THE WEB-APP TO PASS SCHEMATIZED SENTENCES TO STREAMLIT. do NOT use this. MAJORLY unsafe. SERIOUSLY.
"""
pargument uses:
